...
import { Routes, Route, useNavigate, NavLink, useLocation, Outlet } from 'react-router-dom'; // Import Outlet for nested routing
    ...
    return (
        <div className='flex'>
            <Sidebar>
                ...
                <NavLink to={'/poll/my-poll'}><SidebarItem icon={<ion-icon name="bar-chart-outline"></ion-icon>} text={'My Polls'} active={location.pathname === '/poll/yourpoll'} /></NavLink>
                <NavLink to={'/poll/my-vote'}><SidebarItem icon={<ion-icon name="bar-chart-outline"></ion-icon>} text={'My votes'} active={location.pathname === '/poll/yourvote'} /></NavLink>
